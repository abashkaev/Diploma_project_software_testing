...
7. ОР: Форма отправленна, появилось сообщение о статусе запроса, в БД внесена соответствующая запись
...
ОР: Поле не приняло значение и осталось пустым.
4. Попытка отправить форму, в которой поле "Номер карты" сожержит одну цифру, при покупке билета. Остальные поля заполнены валидными данными.  
ОР: Запрос не отправлен, рядом с полем появилось сообщение:"Неверный формат"
...
16. Попытка отправить форму, где поле "Год" сожержит значение текущий год + 6, при покупке билета. Остальные поля заполнены валидными данными.  
